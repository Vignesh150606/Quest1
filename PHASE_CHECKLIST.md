...
- [ ] **Phase 0** - Environment sanity — `python verify.py 0`
- [ ] **Phase 1** - Ingest + shared schema — implement `src/ingest.py`, remove skip in `tests/test_ingest.py`, then `python verify.py 1`
